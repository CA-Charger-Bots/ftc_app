...
public class TeleOpMain extends OpMode
{
    ...
    public void loop() {
        ...
        //Relic Wrist
        robot.relicWrist.setPosition(robot.relicWrist.getPosition() + gamepad1.right_trigger * 0.0002);
        robot.relicWrist.setPosition(robot.relicWrist.getPosition() - gamepad1.left_trigger * 0.0002);
